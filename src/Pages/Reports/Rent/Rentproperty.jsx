                ...
                <div className="row       ">
                    ...
                    <div className="col-md-2 mb-2 ">
                        <div className="bg-secondary bg-opacity-50 py-2 rounded text-center shadow text-light ">
                            <h5 className="p-0 m-0">0 Occupied</h5>
                            <p className="p-0 m-0">$0 per month</p>
                        </div>
                    </div>
                    <div className="col-md-2 mb-2 ">
                        <div className="bg-secondary bg-opacity-50 py-2 rounded text-center shadow text-light ">
                            <h5 className="p-0 m-0">0 Expiring in 90 Days</h5>
                            <p className="p-0 m-0">$0 per month</p>
                        </div>
                    </div>
                    <div className="col-md-2 mb-2 ">
                        <div className="bg-secondary bg-opacity-50 py-2 rounded text-center shadow text-light ">
                            <h5 className="p-0 m-0">5 Vacant</h5>
                            <p className="p-0 m-0">$5,289.00 per month</p>
                        </div>
                    </div>
