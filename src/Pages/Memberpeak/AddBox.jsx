  ...
  return (
    <>
      <div className="container-fluid" style={{ background: "rgb(85, 173, 234)" }}>
        <div className="row">
          <h2 className="text-light" style={{ fontSize: "1.6rem", fontWeight: 700 }}>
            Featured Offers 🔥
          </h2>
          <div className="col-md-4 col-sm-6 col-12" style={{ height: 530 }}>
          ...
          <div className="col-md-4 col-sm-6 col-12" style={{ minHeight: 530 }}>
            <div className="card border-0 shadow mb-4">
              <div className="card-body">
                <div className="d-flex justify-content-between">
            ...
            <div className="card border-0 shadow mb-4">
              <div className="card-body">
                ...
                <div>
                  ...
                  <p style={{ fontSize: 15 }}>
                    Eliminate the 24/7 hassle of maintenance issues while automating
                    tedious tasks that take up your time.
                  </p>
                </div>
                <div className="btn w-100 mt-5">
                  <button
                    ...
                    className="btn rounded-4 w-100"
                  >
                    Add Premium Maintenance to RentRedi
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="card border-0 shadow mb-4">
              <div className="card-body">
                ...
                <div>
                  ...
                  <p style={{ fontSize: 15 }}>
                    BrightInvestor helps you find the best real estate markets, get
                    MLS access, source off-market deals all in one place. 50% off
                    First Month or 25% off First Year!
                  </p>
                </div>
                <div className="btn w-100 mt-5">
                  <button
            ...
            <div className="card border-0 shadow mb-4">
              <div className="card-body">
                ...
                <div>
                  ...
                  <p style={{ fontSize: 15 }}>
                    Honeycomb provides better coverage and clarity at a fraction of
                    the cost. Get Property &amp; Casualty insurance for landlords,
                    PMs, &amp; owners. Insurance reinvented!
                  </p>
                </div>
                <div className="btn w-100 mt-5">
                  <button
